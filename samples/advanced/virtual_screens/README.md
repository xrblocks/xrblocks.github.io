...
5. Open sender and receiver:
   - _On your computer_, navigate to http://localhost:8080/samples/advanced/virtual_screens/send.html.
   - _On your AndroidXR device_, navigate to http://localhost:8080/samples/advanced/virtual_screens/index.html.
