...
import {UIIcon, UIImage, UIPanel, UIText} from 'uiblocks';
...
class ElementSample extends Sample {
   ...
   */
  private createElementWithLabel(
    parent: UIPanel,
    label: string,
    item: UIText | UIImage | UIIcon,
    width?: number,
    height?: number
  ) {
  ...
  createUI() {
    ...
    const card1 = this.uiCore.createCard({
      ...
      sizeX: 0.8,
      sizeY: 1.0,
      position: new THREE.Vector3(0, 1.7, -1.0),
      behaviors: [],
      flexDirection: 'column',
    ...
    this.createElementWithLabel(
      imageRow,
      'Default',
      new UIImage('https://picsum.photos/id/237/100/100', {
        width: 80,
        height: 80,
        color: 'white',
        opacity: 1,
    ...
    this.createElementWithLabel(
      imageRow,
      'Size',
      new UIImage('https://picsum.photos/id/1084/200/200', {
        width: 120,
        height: 120,
      })
    );
    ...
    this.createElementWithLabel(
      imageRow,
      'Color',
      new UIImage('https://picsum.photos/id/10/160/160', {
        width: 80,
        height: 80,
        color: '#4796e3',
        opacity: 1,
    ...
    this.createElementWithLabel(
      imageRow,
      'Opacity',
      new UIImage('https://picsum.photos/id/11/160/160', {
        width: 80,
        height: 80,
        color: 'white',
        opacity: 0.2,
    ...
    this.createElementWithLabel(
      imageRow,
      'Rounded Corners',
      new UIImage('https://picsum.photos/id/100/160/160', {
        width: 80,
        height: 80,
        borderRadius: 20,
      })
    ...
    const loopColor = (speed: number = 1.0) => {
      ...
      const frac = t - idx1;
      const color = new THREE.Color(colors[idx1]).lerp(
        new THREE.Color(colors[idx2]),
        frac
      );
  ...
  private dynamicText1!: UIText;
  private dynamicText2!: UIText;
  private dynamicText3!: UIText;
  private dynamicImage1!: UIImage;
  private dynamicImage2!: UIImage;
  private dynamicImage3!: UIImage;
  private dynamicImage4!: UIImage;
  private dynamicImage5!: UIImage;
  private dynamicIcon1!: UIIcon;
  private dynamicIcon2!: UIIcon;
  private dynamicIcon3!: UIIcon;
  private dynamicIcon4!: UIIcon;
}
