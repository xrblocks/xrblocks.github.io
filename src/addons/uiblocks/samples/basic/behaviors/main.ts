...
class BehaviorSample extends Sample {
  ...
  createUI() {
    ...
    const leashSection = this.createSectionWithTitle(
      card1,
      'Head Leash',
      '100%',
      '100%'
    ...
    leashSection.add(
      new UIText('Always follows camera.', {
        color: 'white',
        fontSize: 14,
      })
    );
    ...
    const billboardSection = this.createSectionWithTitle(
      card2,
      'Billboard',
      '100%',
      '100%'
    );
    billboardSection.add(
      new UIText('Always faces camera.', {
        color: 'white',
        fontSize: 14,
      })
    );
    ...
    const panelSection = this.createSectionWithTitle(
      card3,
      'Manipulation',
      '100%',
      '100%'
    ...
    const anchorSection = this.createSectionWithTitle(
      card4,
      'Object Anchor',
      '100%',
      '100%'
    ...
    anchorSection.add(
      new UIText('Attached to the cube.', {
        color: 'white',
        fontSize: 14,
      })
    );
