import e from"@rollup/plugin-terser";import s from"@rollup/plugin-typescript";import{execSync as t}from"child_process";import i from"fs";import{globSync as n}from"glob";import r from"node:path";import{fileURLToPath as o}from"node:url";import{dts as a}from"rollup-plugin-dts";let l=JSON.parse(i.readFileSync("./package.json","utf8")).version,d=process.env.XRBLOCKS_BUILD??"all";i.rmSync(r.join("build","internal"),{recursive:!0,force:!0}),i.rmSync(r.join("build","addons"),{recursive:!0,force:!0});let p="unknown";try{p=t("git rev-parse --short HEAD").toString().trim()}catch{console.error("Could not get the Git commit ID.")}let m=` * Copyright 2025 Google LLC
 *
 ...
 * 1. Include the following importmap for maximum compatibility:
    ...
    lego-styles.
 */`,u=["three",/three\/addons\//,"@google/genai","@mediapipe/tasks-audio","@mediapipe/tasks-vision","openai","@sparkjsdev/spark",/^lit(\/.*)?$/,"@pmndrs/uikit","@preact/signals-core","rapier3d","three-mesh-bvh","@huggingface/transformers","three-pathfinding","vitest"],h=[{input:"src/entry.ts",external:u,output:{dir:"build",entryFileNames:"xrblocks.js",chunkFileNames:"internal/[name].js",format:"esm",banner:c,sourcemap:!0},plugins:[s({compilerOptions:{composite:!1,declaration:!1}})]},{input:"src/entry.ts",external:u,output:{file:"build/xrblocks.d.ts",format:"esm",banner:c},plugins:[a()]},{input:"src/entry.ts",external:u,output:{dir:"build",entryFileNames:"xrblocks.min.js",chunkFileNames:"internal/[name].min.js",format:"esm",sourcemap:!0},plugins:[s({compilerOptions:{composite:!1,declaration:!1}}),e()],watch:!1},{input:Object.fromEntries(n("src/addons/**/*.{js,ts}",{ignore:["src/addons/**/cli/**","src/addons/**/server/**","src/addons/**/samples/**","src/addons/**/*.d.ts","src/addons/**/*.test.{js,ts}"]}).map(e=>[r.relative("src",e.slice(0,e.length-r.extname(e).length)),o(new URL(e,import.meta.url))])),external:[...u,"xrblocks","netblocks",/xrblocks\/addons\//],output:{dir:"build/",format:"esm"},plugins:[s({tsconfig:"src/addons/tsconfig.lib.json",exclude:["src/!(addons)/**/*.ts","src/*.ts"],compilerOptions:{declaration:!0,declarationDir:"build/addons/"}})]}],g=n("demos/**/*.ts",{ignore:["demos/**/node_modules/**","demos/**/build/**","demos/**/*.test.ts"]}).map(e=>({input:e,external:()=>!0,output:{file:r.join(r.dirname(e),"build",r.basename(e).replace(/\.ts$/,".js")),format:"esm"},plugins:[s({tsconfig:!1,include:[e],compilerOptions:{target:"ES2022",module:"ESNext",moduleResolution:"bundler",esModuleInterop:!0,forceConsistentCasingInFileNames:!0,strict:!0,skipLibCheck:!0,declaration:!1}})]})),f=n("samples/**/*.ts",{ignore:["samples/**/node_modules/**","samples/**/build/**"]}).map(e=>({input:e,external:()=>!0,output:{file:r.join(r.dirname(e),"build",r.basename(e).replace(/\.ts$/,".js")),format:"esm"},plugins:[s({tsconfig:!1,include:[e],compilerOptions:{target:"ES2022",module:"ESNext",moduleResolution:"bundler",esModuleInterop:!0,forceConsistentCasingInFileNames:!0,strict:!0,skipLibCheck:!0,declaration:!1}})]}));export default"sdk"!==d?[...h,...g,...f]:h;