...
import { GradientPanel, GradientPanelProperties } from '../primitives/GradientPanel';
/**
 ...
 */
export declare class UIPanel extends UIPanel_base {
    private _onHoverEnter?;
    private _onHoverExit?;
    onClick?: () => void;
    /**
     ...
     */
    onHoverEnter(controller: THREE.Object3D): boolean;
    /**
     * Internal hook triggered by Mixin beam listeners to trigger user pointer exit hooks.
     */
    onHoverExit(controller: THREE.Object3D): boolean;
    /**
