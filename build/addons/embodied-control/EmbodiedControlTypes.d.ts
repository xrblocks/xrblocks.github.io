...
export type EmbodiedControlExecutorOptions = Required<Pick<EmbodiedControlOptions, 'tickMs' | 'defaultDurationMs' | 'includeScreenshot' | 'applyHandRotationConstraints' | 'realTime'>>;
