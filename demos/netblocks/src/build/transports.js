...
import { enableNet, WebSocketTransport, WebRTCTransport, BroadcastChannelTransport } from 'xrblocks/addons/netblocks/src/index.js';
...
class TransportsSample extends xb.Script {
    ...
    async _switchTo(name) {
        ...
        try {
            ...
            if (this._statusEl)
                this._statusEl.textContent = ` · failed: ${err.message}`;
        }
    }
}
