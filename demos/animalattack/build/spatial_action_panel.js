...
function createSpatialPanel(width, height, position, rotX) {
...
function buildSpatialActionPanel(scene, position, icon, bgMeshesArray, onTriggerCallback) {
    // Create a transparent layout panel strictly for hosting the icon.
    const panel = createSpatialPanel(PANEL_SIZE, PANEL_SIZE, position, PANEL_ROT_X_OFFSET);
    scene.add(panel);
...
export { buildSpatialActionPanel, createSpatialPanel };
