...
class AudioManager {
    ...
    static playExplosionSound() {
        ...
        bandpass.frequency.exponentialRampToValueAtTime(EXPLOSION_LPF_FREQ_END, now + EXPLOSION_LPF_TIME);
        ...
        gainNode.gain.linearRampToValueAtTime(EXPLOSION_GAIN_MAX, now + EXPLOSION_ATTACK_TIME);
        gainNode.gain.exponentialRampToValueAtTime(EXPLOSION_END_GAIN, now + EXPLOSION_DECAY_TIME);
    ...
    static playZapSound() {
        ...
        osc.frequency.exponentialRampToValueAtTime(ZAP_FREQ_END, now + ZAP_FREQ_TIME);
