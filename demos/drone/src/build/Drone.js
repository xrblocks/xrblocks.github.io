...
class Drone extends xb.Script {
    ...
    updateRigidBody() {
        ...
        if (rightControllerAxes && rightControllerAxes.length >= 4) {
            rotation.premultiply(new THREE.Quaternion().setFromAxisAngle(new THREE.Vector3(0, 1, 0), -this.rotationSpeed * rightControllerAxes[2]));
